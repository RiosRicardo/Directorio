...
class DirectoriesControllerTest < ActionController::TestCase
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post :create, directory: { celular: @directory.celular, ciudad: @directory.ciudad, comuna: @directory.comuna, descripcion: @directory.descripcion, nombre: @directory.nombre, telefono: @directory.telefono, usuario_rut: @directory.usuario_rut }
    end
  ...
  test "should update directory" do
    patch :update, id: @directory, directory: { celular: @directory.celular, ciudad: @directory.ciudad, comuna: @directory.comuna, descripcion: @directory.descripcion, nombre: @directory.nombre, telefono: @directory.telefono, usuario_rut: @directory.usuario_rut }
    assert_redirected_to directory_path(assigns(:directory))
  end
